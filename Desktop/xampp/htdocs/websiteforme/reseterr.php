...
</svg><strong> Error:</strong> You Have Entered Invalid Credentials <a class="mylink" onclick="$('#reset').modal('show');" data-bs-placement="bottom" data-bs-toggle="tooltip"  title="Try Again"><strong> Try Again?</strong></a>.
